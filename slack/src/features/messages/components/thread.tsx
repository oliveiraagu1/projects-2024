...
export const Thread = ({messageId, onClose}: ThreadProps) => {
    ...
    const handleSubmit = async ({body, image}: {
        ...
        try {
            ...
            toast.error("Failed to sendo message!")
        } finally {
            setIsPending(false);
        ...
        return (
            <div className="h-full flex flex-col">
                ...
                <div className="flex flex-col gap-y-2 h-full items-center justify-center">
                    <AlertTriangle className="size-5 animate-bounce text-orange-500"/>
    ...
    return (
        <div className="h-full flex flex-col">
            <div className="h-[49px] flex justify-between items-center px-4 border-b">
                <p className="text-lg font-bold">Thread</p>
                <Button onClick={onClose} size="iconSm" variant="ghost">
                    <XIcon className="size-5 strok-[1.5]"/>
                </Button>
            </div>
                ...
                {isLoadingMore && (
                    <div className="text-center my-2 relative">
                        ...
                        <span
                            className="relative inline-block bg-white px-4 py-1 rounded-full text-xs border border-gray-300 shadow-sm"
                        >
                            <Loader className="size-4 animate-pulse"/>
                    </span>
                    </div>
                )}
                <Message
